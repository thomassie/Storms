...
Not bad, but the residuals (data - fit) seem to show some [heteroskedasticity](https://en.wikipedia.org/wiki/Heteroscedasticity).  Maybe the relationship can be better described by a negativ quadratic fit...?
```{r fig.height = 6, fig.width = 8, messages = FALSE, warning = FALSE}
rho.wind.pres <- cor(dd$Pressure, dd$WindKPH, use = "complete.obs")
# ggplot(data = dd.345,
#        aes(x = DateTime,
