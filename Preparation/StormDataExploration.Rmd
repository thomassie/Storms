...
plot.pressure.main <- ggplot(data = dd,
  ...
  labs(x = "Year", 
       ...
       subtitle = "Storm intensity indicated by minimum in central pressure.",
  ...
  theme(axis.text = element_text(family = "Varela Round"),
        ...
        axis.line = element_blank(),
        plot.title = element_text(face = "bold", hjust = 0, vjust = -1, colour = "#3C3C3C", size = 20),
  ...
  theme(legend.title = element_text(size=10, color = "Ocean", face="bold"),
...
plot.wind.main <- ggplot(data = dd,
  ...
  labs(x = "Year", 
       ...
       title = "Do extreme events become more severe?",
       subtitle = "Storm intensity indicated by maximum wind speed.",
       caption = "Source: NOAA's National Hurricane Center (http://www.nhc.noaa.gov/data/)") +
  # ggpubr::color_palette("jco") +
  # scale_colour_manual(values = c("#B78A3F", "#58758C")) +
  scale_colour_manual(values = c("#FF281E", "#0090CF")) +
...
Now, one can combine all three plots to a single figure.
```{r fig.height = 6, fig.width = 8, messages = FALSE, warning = FALSE}
plot.wind.1 <- insert_xaxis_grob(plot.wind.main, plot.wind.dens.x, grid::unit(0.2, "null"), 
                                 position = "top")
plot.wind.2 <- insert_yaxis_grob(plot.wind.1, plot.wind.dens.y, grid::unit(.2, "null"), 
                                 position = "right")
ggdraw(plot.wind.2)
```
...
```{r fig.height = 6, fig.width = 8, messages = FALSE, warning = FALSE}
dd.HU <- filter(dd, Status == "HU")
dd.345 <- filter(dd, SaffirSimpson == "3" | SaffirSimpson == "4" | SaffirSimpson == "5")
...
ggplot(data = dd.345,
  ...
  geom_point(aes(size = (WindKPH^1.2)/50,
                 colour = WindKPH),
             alpha = 0.5) +
  theme(axis.text = element_text(family = "Varela Round", size = 10),
        axis.ticks = element_line(colour = "#D7D8D8", size = 0.2),
        axis.ticks.length = unit(5, "mm"),
        axis.line = element_blank(),
        panel.background = element_rect(fill = "#F0F0F0"),
...
ggplot(data = dd.345,
  ...
  # geom_hline(yintercept = 209) +
  geom_point(aes(size = (WindKPH^1.2)/50,
                 colour = SaffirSimpson),
             alpha = 0.3) +
  scale_colour_manual(values = c("#B3B747", "#A98EA3", "#D49B3D")) +
  theme(axis.text = element_text(family = "Varela Round", size = 10),
        axis.ticks = element_line(colour = "#D7D8D8", size = 0.2),
        axis.ticks.length = unit(5, "mm"),
        axis.line = element_blank(),
